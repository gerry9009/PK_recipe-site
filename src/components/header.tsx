...
export default function Header(props: {
  setNewsletterShown: Dispatcher<boolean>;
  ...
  return (
    <header>
      ...
      {!showSliderMenu && (
        <label
          className="hamburger-menu-label"
          onClick={clickHamburgerMenu}
          tabIndex={0}
          onKeyDown={keyDownkHamburgerMenu}
          ref={hamburgerMenuFocus}
        >
      ...
      <Menu
        ...
        setHamburgerMenuClass={setHamburgerMenuClass}
      />
    </header>
  );
}
